    ...
    <div className="w-full flex flex-col lg:flex-row px-8 md:px-10 gap-10 2xl:gap-20 py-20">
      ...
      >
        ...
        <div className="flex gap-4 items-center my-4">
          ...
          <div className=" font-bold text-center text-5xl text-transparent bg-clip-text bg-gradient-to-r from-white to-white">
            <TypewriterComponent
            options={{
              strings:[
        ...
        <p className=" text-md text-black dark:text-gray-100 mt-5 2xl:mt-10">
          Full-Stack Web Developer with ability to learn and collaborate
        ...
        <div className=" mt-10 flex gap-10">
          ...
          <a href="https://eu.docworkspace.com/d/sIOaEhq5oicaWqQY?sa=e1&st=0t">
